...
public class Song99bottlesTest {
    @Test
    public void testLiricsText() throws InterruptedException{
        ...
        driver.findElement(By.xpath("//a[@href='lyrics.html']")).click();
      ...
      //  {
        ...
        String[] pText = new String[100];
        {
            for (int i = 0; i < pText.length; i++) {
                int index = i +1;
                pText[i] = driver.findElement(By.xpath("//body/div[@id='wrap']/div[@id='main']/p["+index+"]")).getText();
            }
              Thread.sleep(100);
                String actualResult = "";
            for (int i = 0; i < pText.length; i++) {
